  ...
  return (
    <div className="h-dvh flex flex-col bg-white dark:bg-gray-950">
      ...
      <div className="safe-top sticky top-0 z-10 bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 px-4 py-3 flex items-center gap-3">
        ...
        >←</button>
        <h1 className="text-gray-900 dark:text-white font-bold text-lg flex-1 truncate">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 flex flex-col gap-4">
        ...
        <label className="flex flex-col gap-1">
          <span className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wider">Name</span>
          <input
            type="text"
            placeholder="My workout"
            value={list.name}
            onChange={(e) => setList((l) => ({ ...l, name: e.target.value }))}
            className="w-full bg-gray-100 dark:bg-gray-800 rounded-lg px-4 py-2.5 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </label>
        ...
        <div className="flex gap-3">
          <label className="flex-1 flex flex-col gap-1">
            <span className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wider">Rest time (sec)</span>
            <input
              type="text"
              inputMode="numeric"
              value={restStr}
              ...
              className="w-full bg-gray-100 dark:bg-gray-800 rounded-lg px-4 py-2.5 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </label>
          ...
          <label className="flex items-end gap-2 pb-2.5 cursor-pointer">
            ...
            />
            <span className="text-sm text-gray-700 dark:text-gray-300 whitespace-nowrap">Start/Stop beeps</span>
          </label>
        </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <button
            ...
            className="w-full py-2.5 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-700 text-gray-400 dark:text-gray-400 hover:border-blue-500 hover:text-blue-500 transition text-sm font-medium"
          >
            + Add Track
          </button>
        </div>
      ...
      {/* Footer actions */}
      <div className="sticky bottom-0 bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 px-4 py-3 flex flex-col gap-2">
        {showSaveAs && (
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 bg-gray-100 dark:bg-gray-800 rounded-lg px-3 py-2 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
              autoFocus
            />
            <button
        ...
        <div className="flex gap-2">
          <button
            ...
            className="flex-1 py-2.5 rounded-lg bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-200 text-sm font-medium hover:bg-gray-300 dark:hover:bg-gray-600 active:scale-[0.98] transition"
          >
            Save as…
          </button>
          <button
